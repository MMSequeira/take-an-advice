...
public aspect Precedence {
	declare precedence :
		pt.iscte.dsi.taa.policies.stack.StackReplica+,
		pt.iscte.dsi.taa.policies.accessibility.classes.Enforcer+,
		pt.iscte.dsi.taa.policies.accessibility.instances.Enforcer+,
		*;
}
